Write-Host "🗳️  Adding Dummy Voters for Demo..." -ForegroundColor Cyan
...
Write-Host "`n✅ Copy the above SQL and run it in pgAdmin or your PostgreSQL client" -ForegroundColor Green
Write-Host "`nOR you can manually execute:" -ForegroundColor Cyan
Write-Host "1. Open pgAdmin" -ForegroundColor White
Write-Host "2. Connect to 'voting_system' database" -ForegroundColor White
...
Write-Host "`n🎉 This will add 6 pending voters for your demo!" -ForegroundColor Green
